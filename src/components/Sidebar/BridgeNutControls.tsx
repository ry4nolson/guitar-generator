...
export function BridgeNutControls({ section = 'all' }: { section?: 'all' | 'bridge' | 'nut' }) {
    ...
    <section className="sidebar-section">
      {showBridge && (
        <>
          ...
          <h3 className="feature-heading">Strings</h3>
          ...
          <p className="muted">Strings also appear as a layer — toggle here or in Stage → Layers.</p>
        </>
      )}

      {showNut && (
        <>
          <h3 className={showBridge ? 'feature-heading' : undefined}>Nut</h3>
